...
public final class NoticeUseCase: NoticeUseCaseProtocol {
    ...
    /// - Returns: 저장된 파일 ID
    public func uploadNoticeAttachmentImage(imageData: Data, fileName: String?) async throws -> String {
    ...
    public func addVote(
        ...
        return try await repository.addVote(
    ...
    public func submitVoteResponse(noticeId: String, optionIds: [String]) async throws {
        guard !noticeId.isEmpty, noticeId != "0" else {
    ...
    public func updateNotice(
        ...
        return try await repository.updateNotice(
            noticeId: String(noticeId),
            title: title,
            content: content
        )
    ...
    public func getAllNotices(
        ...
        guard !request.gisuId.isEmpty, request.gisuId != "0" else {
