...
extension NoticeEditorViewModel {
    ...
    public func showVotingFormSheet() {
        if isVoteConfirmed {
    ...
    @MainActor
    public func loadSelectedPhotoItemsForNoticeUpload() async {
    ...
    public func removeImage(_ item: NoticeImageItem) {
    ...
    public func removeLink(_ link: NoticeLinkItem) {
