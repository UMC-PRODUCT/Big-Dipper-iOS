...
extension EditorToolbarViewModel {
    ...
    public func resolvedFont(from attribute: Any?, at location: Int, in storage: NSTextStorage) -> UIFont {
    ...
    public func font(for style: EditorParagraphStyle) -> UIFont {
        switch style {
        case .title:
    ...
    public func updatedFont(from font: UIFont, toggling trait: UIFontDescriptor.SymbolicTraits, enabled: Bool) -> UIFont {
        // Pretendard 폰트 전용 처리
    ...
    /// 폰트의 굵기 값을 추정합니다.
    public func weight(for font: UIFont) -> CGFloat {
    ...
    public func isFontBold(_ font: UIFont) -> Bool {
        if font.fontName.hasPrefix("Pretendard") {
    ...
    public func rangeHasUniformFontTrait(_ range: NSRange, trait: UIFontDescriptor.SymbolicTraits, in storage: NSTextStorage) -> Bool {
    ...
    public func rangeHasUniformTextDecoration(_ range: NSRange, key: NSAttributedString.Key, in storage: NSTextStorage) -> Bool {
        guard range.length > 0 else { return false }
    ...
    public func uniformHighlightColor(in range: NSRange, storage: NSTextStorage) -> Color? {
    ...
    public func nsParagraphStyle(at location: Int, in storage: NSTextStorage) -> NSParagraphStyle {
    ...
    public func detectedParagraphStyle(at location: Int, in storage: NSTextStorage) -> EditorParagraphStyle {
    ...
    public func isBlockquoteAttributeEnabled(at location: Int, in storage: NSTextStorage) -> Bool {
    ...
    public func listPrefix(for style: EditorListStyle) -> String {
        switch style {
        case .bullet:
            return "• "
        case .dash:
    ...
    public func listStyleIdentifier(for style: EditorListStyle) -> String {
        switch style {
        case .bullet:
            return "bullet"
        case .dash:
    ...
    public func existingListPrefixRange(in paragraphText: String) -> NSRange? {
    ...
    public func detectedListStyle(in paragraphRange: NSRange, storage: NSTextStorage) -> EditorListStyle? {
    ...
    public func colorsEqual(_ lhs: UIColor?, _ rhs: UIColor?) -> Bool {
        switch (lhs, rhs) {
        case (nil, nil):
            return true
        case let (lhs?, rhs?):
